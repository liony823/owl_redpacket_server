...
public class SecurityUtils {
    ...
    public static String getUserId() {
        try {
            ...
            throw new AuthException("获取用户ID异常" + HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public static String getUsername() {
        try {
            ...
            throw new AuthException("获取用户账户异常" + HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public static LoginUser getLoginUser() {
        try {
            ...
            throw new AuthException("获取用户信息异常" + HttpStatus.UNAUTHORIZED);
        }
    }
